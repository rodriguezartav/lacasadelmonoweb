          ...
          <div className="mt-8 xl:mt-0">
            ...
            <form className="mt-4 sm:flex sm:max-w-md">
              ...
              <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                <button className="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-darkseagreen-500 hover:bg-darkseagreen-400 focus:outline-none focus:bg-darkseagreen-400 transition duration-150 ease-in-out">
                  Subscribe
                </button>
              </div>
            </form>
